...
var _sliderJury = require("./modules/slider-jury");
var _sliderReviews = require("./modules/slider-reviews");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  (0, _videoPlayer.initVideo)();
  (0, _sliderJury.setInitJurySlider)();
  (0, _sliderReviews.setInitReviewsSlider)();
...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./modules/slider-jury":13,"./modules/slider-reviews":14,"./modules/tabs/init-tabs":15,"./modules/video-player":17,"./utils/ios-vh-fix":20}],2:[function(require,module,exports){
"use strict";
...
exports.setInitJurySlider = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var jurySlider = document.querySelector('[data-jury-slider]');
var buttonNext = document.querySelector('[data-jury-next]');
var buttonPrev = document.querySelector('[data-jury-prev]');
var initJurySlider = function initJurySlider() {
  return new _swiper.default(jurySlider, {
    navigation: {
      nextEl: buttonNext,
      prevEl: buttonPrev
    },
...
var setInitJurySlider = exports.setInitJurySlider = function setInitJurySlider() {
  if (jurySlider) {
    initJurySlider();
  }
};
...
exports.setInitReviewsSlider = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
...
var setInitReviewsSlider = exports.setInitReviewsSlider = function setInitReviewsSlider() {
  if (reviewsSlider) {
    initReviewsSlider();
  }
};
...
var button = videoContainer.querySelector('[data-video-button]');
